...
_KITTIDATASETCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      has_default_value=True, default_value=_b("~/fakepath").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ground_plane', full_name='avod.protos.KittiDatasetConfig.ground_plane', index=5,
      number=11, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=_b("ground").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='cluster_split', full_name='avod.protos.KittiDatasetConfig.cluster_split', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='classes', full_name='avod.protos.KittiDatasetConfig.classes', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_clusters', full_name='avod.protos.KittiDatasetConfig.num_clusters', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bev_source', full_name='avod.protos.KittiDatasetConfig.bev_source', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='aug_list', full_name='avod.protos.KittiDatasetConfig.aug_list', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='kitti_utils_config', full_name='avod.protos.KittiDatasetConfig.kitti_utils_config', index=11,
